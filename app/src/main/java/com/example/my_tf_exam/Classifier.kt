...
class Classifier(private val assetManager: AssetManager, private val modelName: String) {
    ...
    private fun initModelShape() {
        ...
        Log.d("LEEHC", "LEEHC, modelInputChannel = $modelInputChannel, modelInputWidth = $modelInputWidth, modelInputHeight = $modelInputHeight")
    }
    ...
    private fun convertBitmapGrayByteBuffer(bitmap: Bitmap): ByteBuffer {
        ...
        pixels.forEach { pixel ->
            ...
            Log.d("LEEHC", "LEEHC, normalizedPixelValue = $normalizedPixelValue")
        }
        Log.d("LEEHC", "LEEHC, buffer = ${byteBuffer}")
